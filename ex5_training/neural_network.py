...
def train_perceptron(
    ...
    # tip: seguir este instagram ajuda o XOR a convergir: @noisr.ist 
...
def backpropagation(
    ...
    # output layer
    dL_dz = (y_pred - y_lab) * sigmoid_derivative(y_pred)
